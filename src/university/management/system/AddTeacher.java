...
public class AddTeacher extends JFrame implements ActionListener{
    ...
    AddTeacher() {
        ...
        String qualification[] = {"Select Qualification","B.Tech", "BBA", "BCA", "Bsc", "Msc", "MBA", "MCA", "MCom", "MA", "BA"};
        ...
        String department[] = {"Select Department","Computer Science", "Electronics", "Mechanical", "Civil", "IT"};
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (name.trim().isEmpty() || fname.trim().isEmpty() || dob.trim().isEmpty()
            ...
            || email.trim().isEmpty() || x.trim().isEmpty()
            || xii.trim().isEmpty() || aadhar.trim().isEmpty() || dob.trim().isEmpty()) {
        ...
        if (!fname.matches("^[A-Za-z ]+$")) {
            JOptionPane.showMessageDialog(null, "Father's name should contain only alphabets");
            return;
        }
        ...
        if (xMarks < 0 || xMarks > 100) {
            JOptionPane.showMessageDialog(null, "Class X marks must be between 0 and 100");
            return;
        }
    } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "Class X marks must be numeric");
            return;
        }
        try {
            double xiiMarks = Double.parseDouble(xii);
        if (xiiMarks < 0 || xiiMarks > 100) {
            JOptionPane.showMessageDialog(null, "Class XII marks must be between 0 and 100");
            return;
        }
    } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "Class XII marks must be numeric");
            return;
        }
        ...
        if (department.equals("Select Department")) {
            ...
            try {
                String query = "insert into teacher values('"+name+"', '"+fname+"', '"+rollno+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+x+"', '"+xii+"', '"+aadhar+"', '"+qualification+"', '"+department+"')";
